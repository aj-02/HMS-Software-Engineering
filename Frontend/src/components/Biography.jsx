    ...
    <>
      <div className="container biography">
        ...
        <div className="banner">
          ...
          <h3>Who We Are</h3>
          <p>
          MediSync stands as a leader in healthcare, offering exceptional patient-centered care and innovative medical solutions. Our team of skilled professionals ensures personalized and comprehensive treatment across various specialties, from advanced diagnostics to cutting-edge therapies.
          </p>
          <br />
          <p>
